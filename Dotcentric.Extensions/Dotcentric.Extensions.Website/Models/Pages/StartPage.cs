...
using Dotcentric.Extensions.Website.Models.Blocks;
...
namespace Dotcentric.Extensions.Website.Models.Pages
{
    ...
    [AvailableContentTypes(
        ...
        Include = new[] { typeof(ContainerPage), typeof(ProductPage), typeof(StandardPage), typeof(ISearchPage), typeof(LandingPage), typeof(ContentFolder), typeof(TestsPage) }, // Pages we can create under the start page...
